          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <CardHeader className="p-0 mb-4">
                <CardTitle className="text-4xl md:text-6xl font-bold mb-2">
                  Hello, I&apos;m Anil Talla
                </CardTitle>
                <CardDescription className="text-2xl md:text-3xl text-muted-foreground">
                  Director of Engineering at Autodesk, Inc.
                </CardDescription>
              </CardHeader>
              <p className="text-lg mb-6">
                I&apos;m a passionate software engineering technology leader who
                loves building products and solving complex business problems in a
                simple way. Though I enjoy leading &amp; managing engineering
                teams, I also love coding, architecting, and sharing my learnings.
              </p>
              <p className="text-lg mb-8">
                I am here to share knowledge, visit my profile &amp; stay
                connected with me.
              </p>
              <Blurb />
